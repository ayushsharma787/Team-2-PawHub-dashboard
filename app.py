...
div[data-testid="metric-container"] label{
  color:#7A5C44!important;font-size:0.72rem!important;font-weight:700!important;
    ...
    if filtered.empty:
        ...
        for col_w, (val, icon, color, desc) in zip([c_inf1,c_inf2,c_inf3,c_inf4], inf_data):
            col_w.markdown(
                ...
                f'<div style="color:#7A5C44;font-size:.78rem">{desc}</div>'
                f'</div>', unsafe_allow_html=True)
...
# ══════════════════════════════════════════════════════════════════════════════
    ...
    st.markdown(
        ...
        f'<div style="color:#7A5C44;font-size:.88rem;margin-top:4px">'
    ...
    st.markdown(
        ...
        f'border-radius:10px;padding:10px 16px;margin-bottom:16px;color:#4A2C1A;font-size:.88rem">'
